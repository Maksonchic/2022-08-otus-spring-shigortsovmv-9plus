insert into AUTHORS (NICKNAME, LAST_NAME, FIRST_NAME, MIDDLE_NAME, AGE) values ('Michael', 'Last', 'Firstov', 'Middleich', 55);
insert into AUTHORS (NICKNAME, LAST_NAME, FIRST_NAME, MIDDLE_NAME, AGE) values ('qwe', 'qweFN', 'qweLN', 'qweMN', 88);
